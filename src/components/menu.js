...
const Menu = ({setOnCarrito, onCarrito}) => {
    ...
    return(
        <div class="sticky top-0 z-10 w-full">
            <nav class="dark:bg-gray-900 dark:text-white bg-white"> {/*m-4 my-0 rounded-b-lg*/}
                <div class="container max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <div>
                        <a class="flex items-center hover:text-gray-200 cursor-pointer" onClick={() => onCarrito ? setOnCarrito(false) : setOnCarrito(true)}>
                    ...
                    <div class="relative">
                        ...
                        <div id="dropdownHover" class="hidden fixed z-10 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                            ...
                            <li class="bg-red-600 text-white">
                                <a onClick={logout} class="cursor-pointer block px-4 py-2 hover:bg-red-500">Cerrar sesión</a>
                            </li>
                            </ul>
                        </div>
                    </div>
