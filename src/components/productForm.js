            ...
            <div class="w-full rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0 bg-gray-900">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form method="POST" class="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div>
                            <label class="block mb-2 text-sm font-medium text-white dark:text-white">Calidad</label>
                            <input onChange={handleChange} type="text" name="calidad" id="calidad" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Nivel 3, Nivel 2, Nivel 1" required="true"/>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input onChange={handleChange} type="text" name="origen" id="origen" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Cuidad, País, Continente, Zona" required="true"/>
                        </div>
