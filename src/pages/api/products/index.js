...
const saveProduct = async (req, res) => {
    const {nombre, precio, momento, origen, url} = req.body;
    ...
    //INSERCION DE DATOS            
    const result = await conn.query('INSERT INTO PRODUCTO (nombre, precio, momento, origen, url) VALUES ($1, $2, $3, $4, $5)', [
        _nombre, 
        _precio, 
        _momento, 
        _origen,
    ...
    console.log(result)
    return res.status(200).json({nombre, precio, momento, origen, url});
}